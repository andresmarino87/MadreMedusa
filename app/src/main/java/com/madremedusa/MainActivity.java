...
// 	    		this.getSupportActionBar().setSubtitle(R.string.revista);
 	    		break;
 	    	case 1:
 	    		fragmentManager = getSupportFragmentManager();
 	    		fragmentManager.beginTransaction().replace(R.id.container, PostFragment.newInstance()).commit();
// 	    		this.getSupportActionBar().setSubtitle(R.string.blog);
 	    		break;
 	    	case 2:
 	    		try{
     	        	...
     	        	Log.e(context.getPackageName(),"NO APP TWITTER NATIVE "+e);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	switch(item.getItemId()){
	    	case R.id.clear_cache:
	    		new DrawableManager(context,context.getResources().getDrawable(R.drawable.ic_launcher)).clearCache();
	            return true;
